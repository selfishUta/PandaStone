            ...
            <div class="sidebar-panel-content fullwidth pt0">
                    ...
                    <ul class="chat-ui bsAccordion">
                            ...
                            <ul class="in">
                                <li>
                                    <a href="#" class="chat-name">
                                        <img class="chat-avatar" src="{{asset('admin')}}/img/avatars/49.jpg" alt="@chadengle">Chad Engle
                                ...
                                <li>
                                    <a href="#" class="chat-name">
                                        <img class="chat-avatar" src="{{asset('admin')}}/img/avatars/54.jpg" alt="@alagoon">Anthony Lagoon</a>
                                    <span class="status offline"><i class="en-dot"></i></span>
                                </li>
                                <li>
                                    <a href="#" class="chat-name">
                                        <img class="chat-avatar" src="{{asset('admin')}}/img/avatars/52.jpg" alt="@koridhandy">Kory Handy</a>
                                    <span class="status"><i class="en-dot"></i></span>
                                </li>
                                <li>
                                    <a href="#" class="chat-name">
                                        <img class="chat-avatar" src="{{asset('admin')}}/img/avatars/50.jpg" alt="@divya">Divia Manyan</a>
                                    <span class="status"><i class="en-dot"></i></span>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="in">
                                <li>
                                    <a href="#" class="chat-name">
                                        <img class="chat-avatar" src="{{asset('admin')}}/img/avatars/51.jpg" alt="@kolage">Eric Hofman</a>
                                    <span class="status online"><i class="en-dot"></i></span>
                                </li>
                                <li>
                                    <a href="#" class="chat-name">
                                        <img class="chat-avatar" src="{{asset('admin')}}/img/avatars/55.jpg" alt="@mikebeecham">Mike Beecham</a>
                                    <span class="status online"><i class="en-dot"></i></span>
                                </li>
                                <li>
                                    <a href="#" class="chat-name">
                                        <img class="chat-avatar" src="{{asset('admin')}}/img/avatars/53.jpg" alt="@derekebradley">Darek Bradly</a>
                                    <span class="status online"><i class="en-dot"></i></span>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul>
                                <li>
                                    <a href="#" class="chat-name">
                                        <img class="chat-avatar" src="{{asset('admin')}}/img/avatars/56.jpg" alt="@laurengray">Lauren Grey</a>
                                    <span class="status offline"><i class="en-dot"></i></span>
                                </li>
                                <li>
                                    <a href="#" class="chat-name">
                                        <img class="chat-avatar" src="{{asset('admin')}}/img/avatars/49.jpg" alt="@chadengle">Chad Engle</a>
                                    <span class="status offline"><i class="en-dot"></i></span>
                                </li>
                                <li>
                                    <a href="#" class="chat-name">
                                        <img class="chat-avatar" src="{{asset('admin')}}/img/avatars/58.jpg" alt="@frankiefreesbie">Frankie Freesibie</a>
                                    <span class="status offline"><i class="en-dot"></i></span>
                                </li>
                                <li>
                                    <a href="#" class="chat-name">
                                        <img class="chat-avatar" src="{{asset('admin')}}/img/avatars/57.jpg" alt="@joannefournier">Joane Fornier</a>
                                    <span class="status offline"><i class="en-dot"></i></span>
                                </li>
                                <li>
                                    <a href="#" class="chat-name">
                                        <img class="chat-avatar" src="{{asset('admin')}}/img/avatars/59.jpg" alt="@aiiaiiaii">Alia Alien</a>
                                    <span class="status offline"><i class="en-dot"></i></span>
                                </li>
                            </ul>
                        </li>
                ...
                <div class="chat-box">
                    ...
                    <ul class="chat-ui chat-messages">
                        <li class="chat-user">
                            <p class="avatar">
                                <img src="{{asset('admin')}}/img/avatars/49.jpg" alt="@chadengle">
                            </p>
                        ...
                        <li class="chat-me">
                            <p class="avatar">
                                <img src="{{asset('admin')}}/img/avatars/48.jpg" alt="SuggeElson">
                            </p>
