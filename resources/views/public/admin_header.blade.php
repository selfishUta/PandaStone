                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu email" role="menu">
                            ...
                            <li class="mail-list clearfix">
                                <a href="#">
                                    <img src="{{asset('admin')}}/img/avatars/128.jpg" class="mail-avatar pull-left" alt="avatar">
                                    <p class="name">
                            ...
                            <li class="mail-list clearfix">
                                <a href="#">
                                    <img src="{{asset('admin')}}/img/avatars/129.jpg" class="mail-avatar pull-left" alt="avatar">
                                    <p class="name">
                            ...
                            <li class="mail-list clearfix">
                                <a href="#">
                                    <img src="{{asset('admin')}}/img/avatars/130.jpg" class="mail-avatar pull-left" alt="avatar">
                                    <p class="name">
                            ...
                            <li class="mail-list clearfix">
                                <a href="#">
                                    <img src="{{asset('admin')}}/img/avatars/131.jpg" class="mail-avatar pull-left" alt="avatar">
                                    <p class="name">
                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown">
                        <a href="#" data-toggle="dropdown">
                            <img class="user-avatar" src="{{asset('admin')}}/img/avatars/48.jpg" alt="SuggeElson">SuggeElson</a>
